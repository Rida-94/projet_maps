	...
	<section id="content">
		<?php
			...
			while ($point = $req->fetch(PDO::FETCH_OBJ)){
				$xml .= "<marker id='".$point->id."' ville='".$point->ville."' lng='".$point->longitude."' lat='".$point->latitude."' pop='".$point->population."' description='".nl2br("&lt;div class=\"window\"&gt;".$point->ville."&lt;br /&gt;&lt;br /&gt;".$point->description."&lt;/div&gt;")."' />";
