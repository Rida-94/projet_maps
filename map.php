<script>
	var lat = 30.4201800; // latitude par défaut
	var lng = -9.5981500; // longitude par défaut
	...
	function initialize(){
		...
		downloadUrl("xml/point.xml", function(data) {
			...
			var population = parseFloat(markers[i].getAttribute("pop"));
			var populationOptions = {
			map: map,
			center:latlng,
			title: parseFloat(markers[i].getAttribute("ville")) ,
